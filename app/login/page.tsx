...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    alert("Google Sign-In is currently unavailable. Please try the demo to explore the app!")
  }
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription>Try our demo to explore the academic dashboard and track your progress</CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            <Button
              ...
              disabled={true}
              className="w-full h-12 bg-gray-100 dark:bg-gray-700 text-gray-400 dark:text-gray-500 border border-gray-200 dark:border-gray-600 cursor-not-allowed transition-all duration-200 shadow-sm"
              variant="outline"
            >
            ...
            <div className="text-center">
              <p className="text-xs text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 p-2 rounded">
                🚀 Try our interactive demo below to explore all features!
              </p>
            </div>
            ...
            <div className="text-center">
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Demo includes full functionality with sample academic data
              </p>
            </div>
          </CardContent>
        </Card>
